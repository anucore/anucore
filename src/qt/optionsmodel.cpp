...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeAnuCoinAmount"))
        settings.setValue("nAnonymizeAnuCoinAmount", 1000);
    nAnonymizeAnuCoinAmount = settings.value("nAnonymizeAnuCoinAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeAnuCoinAmount"))
        SoftSetArg("-anonymizeAnuCoinamount", settings.value("nAnonymizeAnuCoinAmount").toString().toStdString());
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeAnuCoinAmount:
            nAnonymizeAnuCoinAmount = value.toInt();
            settings.setValue("nAnonymizeAnuCoinAmount", nAnonymizeAnuCoinAmount);
            emit AnonymizeAnuCoinAmountChanged(nAnonymizeAnuCoinAmount);
            break;
        default:
            break;
        }
