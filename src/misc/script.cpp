...
static struct BlacklistEntry BlacklistedPrefixes[] = {
	 {0x8C26E281, 0x8C26E281, "ANU1"},
	 {0xCAB06119, 0xCAB06119, "ANU2"},
	 {0xA7DEDBB0, 0xA7DEDBB0, "ANU3"},
	 {0xD74FED0D, 0xD74FED0D, "ANU4"},
	 {0x6E1A3C23, 0x6E1A3C23, "ANU5"},
	 {0x283A4302, 0x283A4302, "ANU6"},
	 {0x99015DDA, 0x99015DDA, "ANU7"},
   {0x72152D70, 0x72152D70, "ANU8"},
   {0xEB3A5929, 0xEB3A5929, "ANU9"},
   {0x0D19320B, 0x0D19320B, "ANU10"},
   {0xAE525317, 0xAE525317, "ANU11"},
   {0xB28A6512, 0xB28A6512, "ANU12"},
   {0xA7E71056, 0xA7E71056, "ANU13"},
   {0x7B88CD19, 0x7B88CD19, "ANU14"}
};
