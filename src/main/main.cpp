...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if (nHeight > 1 && nHeight <= 131400) {
        nSubsidy = 1 * COIN;
    }   
    else if (nHeight > 131400 && nHeight <= 525600) {
        nSubsidy = 2 * COIN;
    }       
    ...
    else if (nHeight > 3153600 && nHeight <= 4204800) {
        nSubsidy = 18 * COIN;
    }
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (pindexBest->nHeight+1 > 0 && pindexBest->nHeight+1 <= 131400) {
        nSubsidy = 2 * COIN;
    }
    else if (pindexBest->nHeight+1 > 131400 && pindexBest->nHeight+1 <= 525600)  {
        nSubsidy = 4 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 525600 && pindexBest->nHeight+1 <= 1051200)  {
        nSubsidy = 6 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 1051200 && pindexBest->nHeight+1 <= 1576800)  {
        nSubsidy = 36 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 1576800 && pindexBest->nHeight+1 <= 2102400)  {
        nSubsidy = 27 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 2102400 && pindexBest->nHeight+1 <= 2628000)  {
        nSubsidy = 18 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 2628000 && pindexBest->nHeight+1 <= 3153600)  {
        nSubsidy = 9 * COIN; 
    }
    else if (pindexBest->nHeight+1 > 3153600 && pindexBest->nHeight+1 <= 4730400) {
        nSubsidy = 6 * COIN;
    }
    else if (pindexBest->nHeight+1 > 4730400) {
        nSubsidy = 3 * COIN;
    }
...
{
    int64_t ret = GetMasternodePayment(nHeight, blockValue) / 100;
    return ret;
}
