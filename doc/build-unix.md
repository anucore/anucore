...
If you want to build AnuCoin-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a AnuCoin-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the AnuCoin directory
BDB_PREFIX="${AnuCoin_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure AnuCoin Core to use our own-built instance of BDB
cd $AnuCoin_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip AnuCoind" to strip the debug
...
Security
---------------------
To help make your AnuCoin installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, AnuCoin should be built with a non-executable stack
